...
interface Props {
  navigation: StackNavigationProp<RootStackParamList, "NewClassScreen">;
}
  ...
  */
  ...
  const saveEvent = async () => {
    ...
    //truct & write the social model to the "socials" collection in Firestore.
      ...
      const db = getFirestore();
      const socialRef = collection(db, "classes");
      const socialDoc: ClassModel = {
  ...
  return (
    <>
      ...
      <View style={{ ...styles.container, padding: 20 }}>
        {/* TextInput */
         <TextInput label="Class Name" value={className} onChangeText={setName} />
        }
        {/* TextInput */
         <TextInput label="Class Lecturer" value={lecturerName} onChangeText={setLecturerName} />
        }
