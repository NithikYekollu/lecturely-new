...
interface Props {
  navigation: StackNavigationProp<LectureStackParamList, "LectureDashboard">;
  route: RouteProp<LectureStackParamList, "LectureDashboard">;
}

export default function LectureDashboard({ route, navigation }: Props) {
